...
namespace Helper
{
    public class SQLHelper
    {
       ...
       // public static String connstr = DecryptText(System.Configuration.ConfigurationManager.ConnectionStrings[ConfigurationSettings.AppSettings["APPID"].ToString()].ToString(), "SilverAmreli");
