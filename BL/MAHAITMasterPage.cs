...
namespace BL
{
    public class MAHAITMasterPage : System.Web.UI.MasterPage
    {
        ...
        public MAHAITMasterPage()
        {
            ...
            if (Convert.ToString(HttpContext.Current.Profile.GetPropertyValue("Selectedlanguage")) != System.Threading.Thread.CurrentThread.CurrentUICulture.Name.ToString())
            {
