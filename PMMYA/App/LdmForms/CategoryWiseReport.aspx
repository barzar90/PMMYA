<%@ Page Language="C#" MasterPageFile="~/Masters/WebSiteMasters/LDM_Master.Master" AutoEventWireup="true" CodeBehind="CategoryWiseReport.aspx.cs" Inherits="PMMYA.App.LdmForms.CategoryWiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="FormsPH" runat="server">
    ...
    <asp:GridView ID="grdReportCategory" CssClass="table table-bordered table-striped" runat="server"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Social_Category" HeaderText="Category" ItemStyle-HorizontalAlign="Left" />
            ...
            <asp:BoundField DataField="ShiOutstandingAmt" HeaderText="Outstanding Amt" ItemStyle-HorizontalAlign="Left" />
            <%-----------%>
            ...
            <asp:BoundField DataField="KisOutstandingAmt" HeaderText="Outstanding Amt" ItemStyle-HorizontalAlign="Left" />
            <%-----------%>
            ...
            <asp:BoundField DataField="TarOutstandingAmt" HeaderText="Outstanding Amt" ItemStyle-HorizontalAlign="Left" />
            <%-----------%>
            ...
            <asp:BoundField DataField="TotalOutstandingAmt" HeaderText="Outstanding Amt" ItemStyle-HorizontalAlign="Left" />
