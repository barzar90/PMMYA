        ...
        <div id="defaultMenu" class=" container">
            ...
            <ul class="other_links">
                <asp:LoginView ID="HeadLoginView" runat="server" EnableViewState="false">
                    <AnonymousTemplate>
                        <li>
                            <asp:Button ID="btnlogin" runat="server" OnClick="btnlogin_Click" CssClass="btnResizer"></asp:Button>
                        </li>
                    </AnonymousTemplate>
                    <LoggedInTemplate>
                ...
                <li>
                    <asp:Button ID="btnHome" runat="server" OnClick="btnHome_Click" CssClass="btnResizer"></asp:Button>
                </li>
                <li>
                    <asp:Button ID="btnContactUs" runat="server" OnClick="btnContactUs_Click" CssClass="btnResizer"></asp:Button>
                </li>
